# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-09-28 17:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='team_requests', to=settings.AUTH_USER_MODEL)),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='membership_requests', to='vcta_service.Team')),
            ],
        ),
        migrations.CreateModel(
            name='Trip',
