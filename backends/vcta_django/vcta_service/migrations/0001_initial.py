# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-04 05:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('captain', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='captain', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Trip',
        ...
        migrations.AddField(
            model_name='user',
            name='team',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='members', to='vcta_service.Team'),
        ),
        migrations.AddField(
            model_name='user',
