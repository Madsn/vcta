<template>
  <div>
    ...
    <!--Stats cards-->
    <div class="row">
      <div class="col-lg-3 col-sm-6" v-for="stats in statsCards" v-bind:key="stats.title">
        <stats-card>
          <div class="icon-big text-center" :class="`icon-${stats.type}`" slot="header">
            <icon :name="stats.icon" scale="3" style="margin-bottom: -8;"></icon>
          </div>
          ...
          <div class="stats" slot="footer">
            <icon :name="stats.footerIcon"></icon> {{stats.footerText}}
          </div>
        </stats-card>
      </div>
    </div>
    ...
    return {
      statsCards: [
        ...
        },
        {
          type: 'info',
          icon: 'calendar',
          title: 'Team Rank - Days',
          value: '4th',
          footerText: '7 days avg',
          footerIcon: ''
        }
      ],
      usersChart: {
